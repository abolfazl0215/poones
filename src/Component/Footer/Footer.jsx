  ...
  return (
    <div
      ...
      <p className="mt-6 text-sm px-4 md:px-32 text-gray-700 leading-6">
        با سلام . ابولفضل مختاری هستم بیش از سه ساله که تو زمینه طراحی
        وب به طور حرفه ای فعالیت دارم. عاشق برنامه نویسی هستم و بیشتر
        از اون عاشق آموزش دادن هستم. تلاش من براین هست که دانش پذیران
        عزیز با آموزش های پیچیده و غیرحرفه ای سردرگم نشن و بتونم به
        عنوان مربی کنارتون باشم چون در زمینه یادگیری مربی مهم ترین
        مساله هست تا شما از از این حرفه دلسرد نشین و امیدوارم که بتونم
        بهتون کلی انگیزه بدم و خیلی پرانرژی این تخصص فوق العاده لذت
        بخش رو یاد بگیرید .
      </p>
