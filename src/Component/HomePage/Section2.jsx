  ...
  return (
    <div className="mt-12 flex flex-wrap justify-around">
      <div className="w-1/2 my-3 p-5  mx-auto rounded-xl box-collapse md:w-1/5 cursor-pointer ">
        ...
        <p className="text-center text-small-bold mt-2">همراهی مربی</p>
        <p className="text-center text-gray-800 text-sm m-2">
      ...
      <div className="w-1/2 my-3 p-5  mx-auto rounded-xl  box-collapse md:w-1/5 cursor-pointer ">
        ...
        <p className="text-center text-small-bold mt-2">تضمین بازگشت وجه</p>
        <p className="text-center text-gray-800 text-sm m-2">
      ...
      <div className="w-1/2 my-3 p-5  mx-auto rounded-xl  box-collapse md:w-1/5 cursor-pointer ">
        ...
        <p className="text-center text-small-bold mt-2">تضمین کیفیت</p>
        <p className="text-center text-gray-800 text-sm m-2">
      ...
      <div className="w-1/2 my-3 p-5  mx-auto rounded-xl  box-collapse md:w-1/5 cursor-pointer ">
        ...
        <p className="text-center text-small-bold mt-2">
          {" "}
